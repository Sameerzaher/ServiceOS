      ...
      <section className="bg-gradient-to-br from-emerald-500 via-emerald-600 to-teal-600 py-20">
        <div className="container mx-auto px-4">
          <h2 className="mb-4 text-center text-4xl font-bold text-white">
            למה לבחור ב-{PRODUCT_BRANDING.name}?
          </h2>
          <p className="mx-auto mb-16 max-w-2xl text-center text-lg text-emerald-50">
            הכל שאתם צריכים כדי לנהל את העסק שלכם בצורה מקצועית
          </p>
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {PRODUCT_BRANDING.benefits.map((benefit, idx) => (
              <div
                key={idx}
                className="rounded-xl bg-white/95 p-6 shadow-lg backdrop-blur-sm transition-all hover:-translate-y-1 hover:bg-white hover:shadow-2xl"
              >
                <p className="text-lg font-medium text-neutral-800">{benefit}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mx-auto grid max-w-5xl gap-10 md:grid-cols-3">
          <div className="text-center">
            ...
            <p className="text-neutral-600">
              מילוי פרטים פשוט וקבלת קישור אישי לדף ההזמנות שלך
            </p>
          </div>
          <div className="text-center">
            <div className="relative mx-auto mb-6 flex h-20 w-20 items-center justify-center">
      ...
      <footer className="border-t border-neutral-200 bg-neutral-50 py-12">
        <div className="container mx-auto px-4">
          <div className="grid gap-8 md:grid-cols-4">
            ...
            <div>
              <h4 className="mb-4 font-semibold text-neutral-900">עקבו אחרינו</h4>
