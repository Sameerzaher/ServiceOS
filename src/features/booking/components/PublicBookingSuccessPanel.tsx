  ...
  return (
    <section
      className={cn(
        ...
        isHilai
          ? "border-pink-200/40 bg-gradient-to-br from-[#fce7f3]/50 via-white to-[#faf5ff] shadow-lg shadow-pink-200/20 dark:border-pink-900/30 dark:from-rose-950/35 dark:to-stone-950/40"
        ...
        {wa ? (
          <a
            ...
            className={cn(
              ...
              isHilai
                ? "border-pink-300/70 bg-gradient-to-r from-pink-400 to-fuchsia-500 shadow-[0_12px_32px_-16px_rgba(219,39,119,0.35)] hover:brightness-[1.05] focus-visible:outline-pink-400/60"
