...
export const ui = {
  ...
  input:
    "w-full min-h-[2.75rem] rounded-xl border border-neutral-300/90 bg-white px-3 py-2.5 text-base leading-normal text-neutral-900 shadow-sm outline-none transition placeholder:text-neutral-400 focus:border-emerald-600 focus:ring-2 focus:ring-emerald-500/25",
