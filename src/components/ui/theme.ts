...
export const ui = {
  pageMain:
    "mx-auto min-h-dvh w-full max-w-2xl px-4 py-5 sm:max-w-3xl sm:px-6 sm:py-10",
  ...
  header:
    "mb-6 border-b border-neutral-200/90 pb-5 sm:mb-10 sm:pb-8",
  card: "rounded-xl border border-neutral-200 bg-white shadow-sm",
  cardHover: "transition hover:border-neutral-300",
  cardPadding: "p-4 sm:p-5",
  statCard:
    "rounded-xl border border-neutral-200 bg-white p-3.5 shadow-sm sm:p-5",
  formCard:
    "rounded-xl border border-neutral-200 bg-white p-5 shadow-sm sm:p-6",
  list: "flex w-full flex-col gap-3.5 sm:gap-4",
  listItem:
    "rounded-xl border border-neutral-200 bg-white px-4 py-5 shadow-sm sm:p-5",
  input:
    "w-full min-h-[2.75rem] rounded-lg border border-neutral-300 bg-white px-3 py-2.5 text-base leading-normal text-neutral-900 shadow-sm outline-none transition placeholder:text-neutral-400 focus:border-neutral-500 focus:ring-2 focus:ring-neutral-400/40",
